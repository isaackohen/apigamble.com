...
class SendCallbackinfo extends Command
{
    ...
    public function handle() {
        ...
        $sendoff = 'http://slots.apigamble.com/api/operator/create?operator='.$operator.'&type=slots&apikey='.$apikey.'&casinoid='.$casinoid.'&home_url='.$home_url.'&evoplayprefix='.$evoplayprefix.'&base='.$callback_urlbase.'&slotsprefix='.$slots_prefix.'&livecasinoprefix='.$livecasino_prefix;
